...
const assets = [
    {
        ...
        description: "Unsere Einsatzfahrzeuge sind strategisch positioniert und mit modernster GPS-Ortung ausgestattet. Dies ermöglicht der Leitstelle, das nächstgelegene Fahrzeug in Sekunden zu identifizieren und zu entsenden.",
        specs: [
    ...
    },
    {
        ...
        description: "Einheitliches, autoritäres Auftreten ist der erste Schritt zur Prävention. Unsere Mitarbeiter tragen zertifizierte Schutzausrüstung, die Sicherheit ausstrahlt und im Ernstfall schützt.",
        specs: [
    ...
    },
    {
        ...
        description: "Kommunikation ist der Schlüssel zur Koordination. Wir nutzen verschlüsselte Digitalfunkgeräte und digitale Wächterkontrollsysteme für eine lückenlose Dokumentation und Verbindung.",
        specs: [
    ...
    },
    {
        ...
        description: "Für Baustellen und Industrieareale ist vollständige persönliche Schutzausrüstung (PSA) Pflicht. Wir halten alle gesetzlichen Sicherheitsvorgaben strikt ein und schulen unser Personal laufend.",
        specs: [
...
const FleetShowcase: React.FC = () => {
    ...
    return (
        <section id="fleet" className="py-24 relative overflow-hidden bg-background" ref={sectionRef}>
                    ...
                    <div className="w-full lg:w-1/3 border-r-0 lg:border-r border-neutral-300 dark:border-neutral-800">
                        {assets.map((item, index) => (
                            ...
                            >
                                ...
                                <ChevronRight className={`w-5 h-5 transition-transform duration-300 ${activeIndex === index ? 'text-foreground translate-x-1' : 'text-neutral-300 opacity-0 group-hover:opacity-100'}`} />
