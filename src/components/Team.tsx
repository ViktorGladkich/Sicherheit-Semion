...
const Team: React.FC = () => {
  ...
  return (
    <section id="team" className="py-24 relative overflow-hidden bg-background" ref={sectionRef}>
      {/* Background Texture */}
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-20 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <p className="text-sm font-mono text-neutral-300 uppercase tracking-widest">{member.role}</p>
              </div>
