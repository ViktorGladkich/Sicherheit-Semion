                    ...
                    return (
                        <div
                            ...
                            className={`
                                ...
                                ${isActive ? 'flex-[3]' : 'flex-[1] hover:flex-[1.2] opacity-80 hover:opacity-100'}
                            `}
                        >
                            {/* Background Image */}
                            <div className="absolute inset-0 w-full h-full">
                                <img 
                                    ...
                                    className={`
                                        ...
                                        ${isActive ? 'scale-100 grayscale-0' : 'scale-110 grayscale brightness-[0.4]'}
                                    `}
                                    loading="lazy"
                                />
                                <div className={`absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent transition-opacity duration-500 ${isActive ? 'opacity-80' : 'opacity-60'}`}></div>
                            </div>
                            ...
                            <div className="absolute inset-0 p-6 flex flex-col justify-end">
                                 <div className="flex items-center gap-3 mb-2">
                                     ...
                                     <h3 className={`text-xl font-bold text-white whitespace-nowrap transition-all duration-500 ${isActive ? 'opacity-100 translate-x-0' : 'opacity-100 lg:opacity-0 lg:-translate-x-10'}`}>
                                         {industry.title}
                                     </h3>
                                 </div>
