...
export const ShieldIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a11.955 11.955 0 0118-8.944c.32.164.634.338.938.528A12.001 12.001 0 0021 12a11.955 11.955 0 01-2.382-6.984z" />
  </svg>
);
export const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21a6 6 0 00-9-5.197m0 0A5.975 5.975 0 0112 13a5.975 5.975 0 016-5.197M15 21a6 6 0 00-9-5.197" />
    </svg>
);
...
export const WifiIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071a10 10 0 0114.142 0M1.394 8.394a15.5 15.5 0 0121.212 0" />
    </svg>
);
...
export const VdsLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="50" y="25" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="middle" fill="currentColor">VdS</text>
    </svg>
);
export const IsoLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 150 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="75" y="25" fontFamily="Arial, sans-serif" fontSize="20" fontWeight="bold" textAnchor="middle" fill="currentColor">ISO 9001</text>
    </svg>
);
export const TuvLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 150 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="75" y="25" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="bold" textAnchor="middle" fill="currentColor">TÜV Rheinland</text>
    </svg>
);
export const BdsLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 120 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="60" y="25" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="middle" fill="currentColor">BDSW</text>
    </svg>
);
...
export const InnovateAgLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 180 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="90" y="25" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="middle" fill="currentColor">Innovate AG</text>
    </svg>
);
export const ConstructGmbhLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 200 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="100" y="25" fontFamily="Arial, sans-serif" fontSize="20" fontWeight="bold" textAnchor="middle" fill="currentColor">Construct GmbH</text>
    </svg>
);
export const EventProLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 150 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="75" y="25" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="middle" fill="currentColor">EventPro</text>
    </svg>
);
export const NextGenCorpLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 190 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="95" y="25" fontFamily="Arial, sans-serif" fontSize="22" fontWeight="bold" textAnchor="middle" fill="currentColor">NextGen Corp.</text>
    </svg>
);
export const AlphaRetailLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 180 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        <text x="90" y="25" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="middle" fill="currentColor">AlphaRetail</text>
    </svg>
);

// Icons for ThemeToggle
