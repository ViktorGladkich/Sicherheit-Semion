          ...
          >
            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              ...
              <p>
                ...
                als dynamischen Prozess. In einer sich ständig wandelnden Welt
                passen wir unsere Strategien proaktiv an neue Bedrohungslagen
                an.
              </p>
              <p className="font-semibold text-foreground">
                Unsere Mission: Wir schaffen den sicheren Raum, in dem Sie sich
