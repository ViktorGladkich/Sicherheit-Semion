    ...
    return (
        ...
        >
            ...
            <div className="relative aspect-[4/3] overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 opacity-60 transition-opacity duration-500 group-hover:opacity-40"></div>
                <img 
                    src={member.image} 
                    alt={member.name}
            ...
            <div className="p-6 md:p-8 flex flex-col flex-grow relative">
                <h3 className="text-2xl font-bold text-foreground mb-1 tracking-tight">{member.name}</h3>
                <p className="text-sm font-mono text-muted-foreground uppercase tracking-widest mb-4">{member.role}</p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                    {member.skills.map((skill, i) => (
                        <span key={i} className="px-2 py-1 bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded text-[10px] uppercase tracking-wide font-semibold text-neutral-600 dark:text-neutral-400 flex items-center gap-1">
